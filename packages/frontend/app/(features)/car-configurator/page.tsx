    ...
    <div className="max-w-4xl mx-auto px-8 py-16 space-y-10">
        <div>
          ...
          <p className="text-zinc-400 text-base max-w-lg leading-relaxed">
            Build your perfect car in real time. Customise colour, wheels,
            and trim in our interactive 3D configurator — then press
            <strong className="text-white"> Start</strong> and drive through a
            virtual world, steered live by tilting your smartphone.
          </p>
        </div>
